...
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop_l)),
                 ordered(1, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop_m)),
                 ordered(2, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop_mh)),
                 ordered(3, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop)),
                 ordered(4, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop_vh)),
                 ordered(5, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
expect_identical(class_burden(score_burden(curr_int, gprev_int, pop_c)),
                 ordered(6, levels = 1:6, labels = c("Low", "Moderate", "Moderately high", "High", "Very high", "Critical")))
...
expect_identical(
  ...
  ordered(1, levels = 1:5, labels = c("Low", "Medium", "High", "Very high", "Critical"))
)
...
expect_identical(
  ...
  ordered(2, levels = 1:5, labels = c("Low", "Medium", "High", "Very high", "Critical"))
)
...
expect_identical(
  ...
  ordered(3, levels = 1:5, labels = c("Low", "Medium", "High", "Very high", "Critical"))
)
...
expect_identical(
  ...
  ordered(4, levels = 1:5, labels = c("Low", "Medium", "High", "Very high", "Critical"))
)
...
expect_identical(
  ...
  ordered(5, levels = 1:5, labels = c("Low", "Medium", "High", "Very high", "Critical"))
)
